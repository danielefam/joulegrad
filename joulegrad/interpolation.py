...
def multilinear_interpolate(
    ...
    *,
    ...
    """Interpolate a scalar while retaining coordinate gradients."""
...
def multilinear_interpolate_batch(
    ...
    *,
    ...
    """Interpolate a batch of points from one rectilinear grid."""
    ...
    for dimension, (lower, upper, fraction) in enumerate(brackets):
        ...
        indices.append(torch.where(use_upper, upper.unsqueeze(1), lower.unsqueeze(1)))
