...
class EnergyLookup:
    ...
    def _estimate(self, key, coordinates):
        ...
        tensor_device = next(
            (
                value.device
                for value in tensor_coordinates
    ...
    def linear(self, input_features, output_features):
        return self._estimate(("linear",), [input_features, output_features])

    def linear_batch(self, input_features, output_features):
        return self._estimate_batch(("linear",), [input_features, output_features])
